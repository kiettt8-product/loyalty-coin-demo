...
if (await page.locator(".promo-reward-item").count() !== 2 || await page.locator(".promo-rule-mode").inputValue() !== "separate") throw new Error("Submitted rewards and separate rule mode must persist");
